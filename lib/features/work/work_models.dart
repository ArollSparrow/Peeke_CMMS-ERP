class WorkRequest {
  ...
  String get title => wrNumber ?? 'Work request';
...
class WorkOrder {
  ...
  String get title => woNumber ?? 'Work order';
  ...
  bool get isOpen => status == 'open' || status == 'in_progress' || status == 'on_hold';
}
...
class WrStatuses {
  static const values = ['pending', 'approved', 'rejected', 'converted', 'cancelled'];
}

class WoStatuses {
  static const values = ['open', 'in_progress', 'on_hold', 'completed', 'cancelled'];
}
