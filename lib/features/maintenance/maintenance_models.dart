...
class DowntimeEvent {
  ...
  /// Duration in hours (0 if still open / missing end).
  double get hours {
  ...
  factory DowntimeEvent.fromMap(Map<String, dynamic> m) => DowntimeEvent(
        id: m['id'] as String,
        organizationId: m['organization_id'] as String,
        systemId: m['system_id'] as String?,
        workOrderId: m['work_order_id'] as String?,
        maintenanceRecordId: m['maintenance_record_id'] as String?,
        startedAt: DateTime.parse(m['started_at'].toString()),
        endedAt: m['ended_at'] != null
            ? DateTime.tryParse(m['ended_at'].toString())
            : null,
        reason: m['reason'] as String?,
        category: m['category'] as String? ?? 'maintenance',
